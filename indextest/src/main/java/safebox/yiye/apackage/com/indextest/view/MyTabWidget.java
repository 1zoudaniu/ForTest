...
import safebox.yiye.apackage.com.indextest.execption.CustomException;
import safebox.yiye.apackage.com.indextest.utils.DensityUtil;
...
public class MyTabWidget extends LinearLayout {
    ...
    private int[] mDrawableIds = new int[]{R.drawable.bg_home, R.drawable.bg_find,
            R.drawable.bg_shopcar,
            R.drawable.bg_mine};
    ...
    public MyTabWidget(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (null == mLabels || mLabels.length <= 0) {
            try {
                ...
                ToastDebugUtils.i(TAG, MyTabWidget.class.getSimpleName() + " 出错");
            }
            a.recycle();
            return;
        }
    ...
    private void init(final Context context) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i == 0) {
                ...
                itemName.setTextColor(Color.rgb(0, 152, 222));
    ...
    public void setTabsDisplay(Context context, int index) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((Integer) (checkedTextView.getTag()) == index) {
                ToastDebugUtils.i(TAG, mLabels[index] + " is selected...");
                checkedTextView.setChecked(true);
                checkedTextView.setTextColor(Color.rgb(0, 152, 222));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        height = Math.max(DensityUtil.dp2dx(getContext(), 60),
                heightSpecSize);
